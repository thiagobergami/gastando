...
const data = {
  categories: [
    {
      category_id: 1,
      name: 'Supermercado',
      examples: 'Pão de Açúcar, Assaí',
      group_id: 1,
      group_name: 'Essenciais / semi-fixos',
      limit_cents: 85000,
      spent_cents: 82100,
      status: 'ok',
    },
  ...
  groups: [
    { group_id: 1, name: 'Essenciais / semi-fixos', limit_cents: 137000, spent_cents: 135900 },
  ],
  totals: {
    spent_cents: 135900,
    teto_cents: 814000,
    savings_goal_cents: 244000,
    projected_savings_cents: 361000,
    vs_goal_cents: 117000,
  },
};
